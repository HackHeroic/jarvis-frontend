...
import { MessageSquare, Plus, Archive, ChevronLeft, Menu, X, Loader2 } from "lucide-react";
            ...
            >
              ...
              {(isHovered || isArchiving) && (
                <button
                  ...
                  className="shrink-0 p-1 rounded text-muted hover:text-red-400 hover:bg-red-400/10 transition-colors disabled:opacity-50"
